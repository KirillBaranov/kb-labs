...
export const indexFlags = defineFlags({
  index: { type: 'string', description: 'Index/corpus id', examples: ['code', 'docs'] },
...
export const searchFlags = defineFlags({
  ...
  index: { type: 'string', description: 'Index/corpus id to search' },
...
export const queryFlags = defineFlags({
  ...
  index: { type: 'string', description: 'Index/corpus id to query' },
  mode: { type: 'string', description: 'Query mode', examples: ['instant', 'auto', 'thinking'] },
});

export const syncPathsFlags = defineFlags({
  index: { type: 'string', description: 'Index/corpus id' },
  json: { type: 'boolean', description: 'Output JSON', default: false },
});
