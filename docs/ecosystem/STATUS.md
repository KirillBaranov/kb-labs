...
This document provides a high-level status overview of all products in the KB Labs ecosystem. For detailed information about each product, see [Products Overview](../products/README.md).
...
|---------|--------|-------|
| [@kb-labs/core](../products/core.md) | MVP 1.0 | Runtime core with profiles resolver/validator |
...
| Product | Status | Notes |
|---------|--------|-------|
| [@kb-labs/audit](../products/audit.md) | MVP 1.0 | Unified quality checks |
| [@kb-labs/rest-api](../products/rest-api.md) | MVP 1.0 | HTTP API layer |
| [@kb-labs/studio](../products/studio.md) | MVP 1.0 | Web dashboard |
