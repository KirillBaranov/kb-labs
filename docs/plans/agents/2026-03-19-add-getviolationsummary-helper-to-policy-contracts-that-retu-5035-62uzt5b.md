# Plan: add getViolationSummary helper to policy-contracts that returns count of violations per rule
## Table of Contents
...
## Task
- User request: add getViolationSummary helper to policy-contracts that returns count of violations per rule
...
- LLM call failed: VibeProxy error: Overloaded
