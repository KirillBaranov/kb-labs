...
The REST API middleware extracts the header and attaches it to the request context. See [`rest-api/src/middleware/rate-limit.ts`](plugins/rest-api/app/src/middleware/rate-limit.ts):
