...
**Source:** [`plugins/commit`](https://github.com/KirillBaranov/kb-labs/tree/main/plugins/commit)
...
From the [manifest](https://github.com/KirillBaranov/kb-labs/blob/main/plugins/commit/entry/src/manifest.ts), the platform surface is small and focused:
...
- [Manifest source](https://github.com/KirillBaranov/kb-labs/blob/main/plugins/commit/entry/src/manifest.ts)
