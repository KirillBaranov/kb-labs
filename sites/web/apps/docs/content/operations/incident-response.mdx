...
- **Workspace adapter failing** — check warnings in logs about workspace adapter missing (see [workflow-daemon bootstrap](plugins/workflow/daemon/src/bootstrap.ts) for the exact warning).
