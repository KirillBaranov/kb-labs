...
It's a small Fastify service. Source: [plugins/marketplace/apps/marketplace/](plugins/marketplace/apps/marketplace/).
...
Source: [apps/marketplace/src/manifest.ts](plugins/marketplace/apps/marketplace/src/manifest.ts).
...
From [`bootstrap.ts`](plugins/marketplace/apps/marketplace/src/bootstrap.ts):
...
```bash
cd plugins/marketplace/apps/marketplace
node ./dist/index.js
```
