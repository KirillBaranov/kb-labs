...
|---|---|---|---|
| [**Gateway**](/gateway) | 4000 | `plugins/gateway` | Central HTTP router, aggregates upstreams, auth termination, WebSocket dispatch |
| [**REST API**](/services/rest-api) | 5050 | `plugins/rest-api` | Fastify service hosting plugin REST routes, platform endpoints, OpenAPI |
