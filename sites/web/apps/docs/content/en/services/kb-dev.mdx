...
The script detects your OS and architecture, downloads the right binary from [GitHub Releases](https://github.com/kb-labs-team/kb-labs/releases), verifies the SHA256 checksum, and installs to `~/.local/bin/kb-dev`. Supports macOS, Linux, and Windows (Git Bash / WSL).
