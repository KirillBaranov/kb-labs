...
**Source:** [`plugins/devlink`](https://github.com/kb-labs-team/kb-labs/tree/main/plugins/devlink)
...
From the [manifest](https://github.com/kb-labs-team/kb-labs/blob/main/plugins/devlink/entry/src/manifest.ts), DevLink is the smallest of the four — it barely needs the platform at all:
...
- [Manifest source](https://github.com/kb-labs-team/kb-labs/blob/main/plugins/devlink/entry/src/manifest.ts)
