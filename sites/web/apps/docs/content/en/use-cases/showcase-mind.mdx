...
**Source:** [`plugins/mind`](https://github.com/kb-labs-team/kb-labs/tree/main/plugins/mind)
...
# Ask a question
pnpm kb mind ask --text "How does the state broker handle tenant isolation?" --agent
```
...
Reading the [manifest](https://github.com/kb-labs-team/kb-labs/blob/main/plugins/mind/entry/src/manifest.ts) tells you the whole story of what Mind needs from the platform:
...
- [Reference manifest](https://github.com/kb-labs-team/kb-labs/blob/main/plugins/mind/entry/src/manifest.ts)
- [mind-core README](https://github.com/kb-labs-team/kb-labs/blob/main/plugins/mind/core/README.md) — hybrid search, anti-hallucination, adaptive weights
