...
pnpm kb marketplace plugins refresh     # Force-reset CLI discovery cache
```
...
2. Cache auto-invalidates on rebuild. If commands are missing: `pnpm kb marketplace plugins refresh`
