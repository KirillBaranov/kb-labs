...
Source of truth: [platform/kb-labs-core/packages/core-platform/src/adapters/analytics.ts](platform/kb-labs-core/packages/core-platform/src/adapters/analytics.ts).
