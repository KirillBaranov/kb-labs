...
Source of truth: [platform/kb-labs-core/packages/core-platform/src/adapters/logger.ts](platform/kb-labs-core/packages/core-platform/src/adapters/logger.ts).
