...
The full resolution algorithm lives in the `ILLMRouter` implementation in `@kb-labs/core-platform` — see [`llm-types.ts`](core/platform/src/adapters/llm-types.ts) for the contract types.
