...
The canonical example is [kb-labs-commit-plugin's manifest.ts](plugins/kb-labs-commit-plugin/packages/commit-cli/src/manifest.ts) which declares 14 routes — browse that for a production-grade reference.
