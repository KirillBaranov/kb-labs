...
The canonical example is [kb-labs-commit-plugin's manifest.ts](plugins/commit/entry/src/manifest.ts) which declares 14 routes — browse that for a production-grade reference.
