...
Полный дизайн — в [ADR-0056](https://github.com/kb-labs-team/kb-labs/blob/main/core/docs/adr/0056-resource-broker-pressure-control.md). Интересная строчка ADR — та, которую мы *не* написали: там нет «и мы также сделали отдельный rate-limiter для HTTP». Это и был соблазн. Устоять — и было настоящей работой.
