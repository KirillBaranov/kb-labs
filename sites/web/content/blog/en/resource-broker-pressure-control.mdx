...
The full design is in [ADR-0056](https://github.com/kb-labs-team/kb-labs/blob/main/core/docs/adr/0056-resource-broker-pressure-control.md). The interesting line in the ADR is the one we did not write — there is no "and we also built a separate rate-limiter for HTTP." That was the temptation. Resisting it was the actual work.
