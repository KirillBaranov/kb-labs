        ...
        <section className={s.hero}>
          ...
          <div className={s.heroCta}>
            ...
            <a
              ...
              href="https://github.com/KirillBaranov/kb-labs-devkit/releases/latest"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <div className={s.platformTable}>
              ...
              {PLATFORMS.map((item) => (
                <div key={item.file} className={s.platformRow}>
                  ...
                  <code>{item.file}</code>
                  <a
                    href={`https://github.com/KirillBaranov/kb-labs-devkit/releases/latest/download/${item.file}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
