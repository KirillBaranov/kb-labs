...
This page documents the shape in full. Source of truth: [`infra/kb-labs-plugin/packages/plugin-contracts/src/context.ts`](infra/kb-labs-plugin/packages/plugin-contracts/src/context.ts).
