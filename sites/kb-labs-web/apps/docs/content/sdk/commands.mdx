...
Everything here comes from [`@kb-labs/shared-command-kit/src/define-command.ts`](platform/kb-labs-shared/packages/shared-command-kit/src/define-command.ts), re-exported via `@kb-labs/sdk`.
