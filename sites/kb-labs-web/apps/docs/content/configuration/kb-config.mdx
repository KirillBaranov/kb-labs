...
The TypeScript source of truth for the `platform` section is [platform/kb-labs-core/packages/core-runtime/src/config.ts](platform/kb-labs-core/packages/core-runtime/src/config.ts). The loader is [config-loader.ts](platform/kb-labs-core/packages/core-runtime/src/config-loader.ts).
...
The canonical list of keys from [`AdaptersConfig`](platform/kb-labs-core/packages/core-runtime/src/config.ts):
