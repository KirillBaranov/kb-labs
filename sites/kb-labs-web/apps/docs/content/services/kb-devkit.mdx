...
Or download a binary directly from [GitHub Releases](https://github.com/KirillBaranov/kb-labs-devkit/releases/latest).
...
- [Source on GitHub](https://github.com/KirillBaranov/kb-labs-devkit-bin) — Go source, issues, releases.
