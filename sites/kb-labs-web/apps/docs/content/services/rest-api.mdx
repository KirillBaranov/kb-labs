...
It's a Fastify 5 app. Source lives in [platform/kb-labs-rest-api/apps/rest-api/](platform/kb-labs-rest-api/apps/rest-api/).
...
Source: [platform/kb-labs-rest-api/apps/rest-api/src/manifest.ts](platform/kb-labs-rest-api/apps/rest-api/src/manifest.ts).

## Bootstrap sequence

On startup, the entrypoint ([`apps/rest-api/src/index.ts`](platform/kb-labs-rest-api/apps/rest-api/src/index.ts)) calls `bootstrap(process.cwd())` from `src/bootstrap.ts`. The bootstrap:
...
Routes live in [`apps/rest-api/src/routes/`](platform/kb-labs-rest-api/apps/rest-api/src/routes/) and are all registered from `routes/index.ts`. The current set:
