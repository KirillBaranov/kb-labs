...
The script detects your OS and architecture, downloads the right binary from [GitHub Releases](https://github.com/KirillBaranov/kb-labs-dev/releases), verifies the SHA256 checksum, and installs to `~/.local/bin/kb-dev`. Supports macOS, Linux, and Windows (Git Bash / WSL).
...
- [Source on GitHub](https://github.com/KirillBaranov/kb-labs-dev) — Go source, issues, releases.
