...
Source of truth: [platform/kb-labs-core/packages/core-platform/src/workspace/workspace-provider.ts](platform/kb-labs-core/packages/core-platform/src/workspace/workspace-provider.ts).
