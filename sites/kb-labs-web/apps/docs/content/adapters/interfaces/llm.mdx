...
Source of truth: [platform/kb-labs-core/packages/core-platform/src/adapters/llm.ts](platform/kb-labs-core/packages/core-platform/src/adapters/llm.ts).
...
Resolution rules (from [llm-types.ts](platform/kb-labs-core/packages/core-platform/src/adapters/llm-types.ts)):
