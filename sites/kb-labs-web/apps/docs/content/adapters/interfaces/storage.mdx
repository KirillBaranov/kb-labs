...
Source of truth: [platform/kb-labs-core/packages/core-platform/src/adapters/storage.ts](platform/kb-labs-core/packages/core-platform/src/adapters/storage.ts).
