...
Source of truth: [platform/kb-labs-core/packages/core-platform/src/environment/environment-provider.ts](platform/kb-labs-core/packages/core-platform/src/environment/environment-provider.ts).
