...
Example from [kb-labs-commit-plugin](plugins/kb-labs-commit-plugin/packages/commit-cli/src/manifest.ts):
...
All of this is importable from `@kb-labs/sdk/studio`. Source: [platform/kb-labs-sdk/packages/sdk/src/studio/index.ts](platform/kb-labs-sdk/packages/sdk/src/studio/index.ts).
