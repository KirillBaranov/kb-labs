...
<#
.SYNOPSIS
    kb-devkit installer for Windows.
.DESCRIPTION
    Downloads kb-devkit for Windows amd64, verifies the SHA-256 checksum,
...
.EXAMPLE
    iwr https://kblabs.ru/kb-devkit/install.ps1 | iex
.EXAMPLE
    iwr https://kblabs.ru/kb-devkit/install.ps1 -OutFile install.ps1; .\install.ps1 -Version v1.2.3
#>
param(
...
Write-Host ""
Write-Host "  KB Labs — kb-devkit installer" -ForegroundColor White
Write-Host ""
...
Write-Host "  kb-devkit run build" -ForegroundColor DarkGray
Write-Host "  kb-devkit health" -ForegroundColor DarkGray
Write-Host ""
