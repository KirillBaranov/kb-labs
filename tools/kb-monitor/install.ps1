...
<#
.SYNOPSIS
    kb-monitor installer for Windows.
.DESCRIPTION
    Downloads kb-monitor for Windows amd64, verifies the SHA-256 checksum,
...
.EXAMPLE
    iwr https://kblabs.ru/kb-monitor/install.ps1 | iex
.EXAMPLE
    iwr https://kblabs.ru/kb-monitor/install.ps1 -OutFile install.ps1; .\install.ps1 -Version v1.2.3
#>
param(
...
Write-Host ""
Write-Host "  KB Labs — kb-monitor installer" -ForegroundColor White
Write-Host ""
...
Write-Host "  kb-monitor watch" -ForegroundColor DarkGray
Write-Host "  kb-monitor status" -ForegroundColor DarkGray
Write-Host ""
