...
func TestHandleInspectIsJSONMachineProtocol(t *testing.T) {
	request := Request{Command: CommandInspect, Scenario: json.RawMessage(`{"schema":"kb.scenario/2","id":"commit","pages":[{"id":"p","sections":[{"id":"s","fields":[{"id":"mode","type":"select","required":true}]}]}]}`)}
...
func TestHandlePlanUsesSharedCompilerAndStructuredError(t *testing.T) {
	...
	response = Handle(Request{Command: CommandInspect, Scenario: json.RawMessage(`{"schema":"kb.scenario/2","id":"commit","pages":[{"id":"p","sections":[]}]}`), State: state})
...
func TestHandlePlanBuildsScenarioStateAndLoadsDefaultCatalog(t *testing.T) {
	response := Handle(Request{
		Command:  CommandPlan,
		Scenario: json.RawMessage(`{"schema":"kb.scenario/2","id":"commit","install":{"components":[{"id":"plugin:commit"}]},"pages":[{"id":"p","sections":[]}]}`),
...
func TestHandlePlanUsesScenarioProviderSelection(t *testing.T) {
	scenario := json.RawMessage(`{"schema":"kb.scenario/2","id":"commit","install":{"components":[{"id":"plugin:commit"}],"providerPreferences":[{"capability":"cache","field":"cache"}]},"pages":[{"id":"p","sections":[{"id":"s","fields":[{"id":"cache","type":"select","required":true,"options":[{"value":"state-broker"},{"value":"redis-cache"}]}]}]}]}`)
...
func TestHandleInspectAdvancesWithActionAndAnswers(t *testing.T) {
	scenario := json.RawMessage(`{"schema":"kb.scenario/2","id":"walk","pages":[{"id":"first","sections":[{"id":"s","fields":[{"id":"mode","type":"select","required":true,"options":[{"value":"quick"}]}]}]},{"id":"second","sections":[]}]}`)
...
func TestHandleInspectReturnsStateOnValidationError(t *testing.T) {
	scenario := json.RawMessage(`{"schema":"kb.scenario/2","id":"walk","pages":[{"id":"first","sections":[{"id":"s","fields":[{"id":"mode","type":"text","required":true}]}]}]}`)
