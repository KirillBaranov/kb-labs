...
func TestRunSealsNormalizedReleaseExport(t *testing.T) {
	...
	if err := os.WriteFile(input, []byte(`{"channels":{"stable":"2.0.0"},"platforms":[{"id":"platform","version":"2.0.0","package":"@kb/platform","sha256":"artifact","profiles":{"default":{}}}]}`), 0o600); err != nil {
		t.Fatal(err)
	}
