...
<#
.SYNOPSIS
    kb-deploy installer for Windows.
.DESCRIPTION
    Downloads kb-deploy for Windows amd64, verifies the SHA-256 checksum,
...
.EXAMPLE
    iwr https://kblabs.ru/kb-deploy/install.ps1 | iex
.EXAMPLE
    iwr https://kblabs.ru/kb-deploy/install.ps1 -OutFile install.ps1; .\install.ps1 -Version v1.2.3
#>
param(
...
Write-Host ""
Write-Host "  KB Labs — kb-deploy installer" -ForegroundColor White
Write-Host ""
...
Write-Host "  kb-deploy push" -ForegroundColor DarkGray
Write-Host "  kb-deploy status" -ForegroundColor DarkGray
Write-Host ""
